...
if(isset($_POST['email'])){
		...
		$the_subject 	= $_POST['contact_subject'];
		$the_continent 	= $_POST['continent'];
		...
		$already_used = array('email','yourname','message','phone','fax','company','website','contact_subject','continent','btnsubmit','myblogname','tempcode','temp_url','ajax');
		$attach = '';
		...
		{ 	
			...
			if(!empty($the_subject)) 	$the_subject 	= "Subject: $the_subject <br/>";
			if(!empty($the_continent))  $the_continent 	= "I found about you from: $the_continent<br/>";
